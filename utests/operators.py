def run_tests_operator(config):
    ...
    scenario.h3("Bob adds THEN removes Operator#1 during the same request on token 0")
    ...
    scenario.h3("Bob removes THEN adds Operator#1 during the same request on token 0")
